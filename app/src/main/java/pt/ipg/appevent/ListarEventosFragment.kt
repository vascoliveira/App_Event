 ...
 * A simple [Fragment] subclass as the second destination in the navigation.
 */
class ListarEventosFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var adapter_eventos: AdapterEvento? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter_eventos = AdapterEvento(this)
