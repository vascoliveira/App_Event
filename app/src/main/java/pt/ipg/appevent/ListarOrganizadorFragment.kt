...
import pt.ipg.appevent.databinding.FragmentListarEventosBinding
import pt.ipg.appevent.databinding.FragmentListarOrganizadorBinding
...
class ListarOrganizadorFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var _binding: FragmentListarOrganizadorBinding? = null
    private var adapter_organizador: AdapterOrganizador? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListarOrganizadorBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        LoaderManager.getInstance(this).initLoader(ID_LOADER_ORGANIZADOR, null, this)

        adapter_organizador = AdapterOrganizador(this)
    ...
    override fun onLoadFinished(loader: Loader<Cursor>, data: Cursor?) {
        adapter_organizador!!.cursor = data
    }
    ...
    companion object {
        const val ID_LOADER_ORGANIZADOR = 0
    }
}